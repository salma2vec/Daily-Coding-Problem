<h2><a href="https://leetcode.com/problems/tiling-a-rectangle-with-the-fewest-squares">Tiling a Rectangle with the Fewest Squares</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>Given a rectangle of size <code>n</code> x <code>m</code>, return <em>the minimum number of integer-sided squares that tile the rectangle</em>.</p>
